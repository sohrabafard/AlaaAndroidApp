...
public class CustomDialogSettingDownload extends DialogPreference {

    private String mValue;


    public CustomDialogSettingDownload(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public CustomDialogSettingDownload(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public CustomDialogSettingDownload(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomDialogSettingDownload(Context context) {
        super(context);
    }
