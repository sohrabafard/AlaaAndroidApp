...
public class CustomCatItem extends LinearLayout {
    ...
    public CustomCatItem(Context context) {
        super(context);
        init(context);
    }

    public CustomCatItem(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CustomCatItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
